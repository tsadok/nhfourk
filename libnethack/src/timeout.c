...
/* Last modified by Fredrik Ljungdahl, 2017-Oct-14 */
        ...
        case 0:
            if (!Blind) {
                if (is_green(&youmonst))
                    pline(msgc_fatal, 
                          "You are turning a more vivid shade of %s.",
                          hcolor("green"));
                else 
                    pline(msgc_fatal, "You are turning a little %s.",
                          hcolor("green"));
            }
            break;
        case 1:
            pline(msgc_fatal, "Your %s are getting oozy.", body_part(LIMBS));
            break;
        case 2:
            pline(msgc_fatal, "Your %s begins to peel away", body_part(BODY));
            break;
        case 3:
            pline(msgc_fatal, "You are turning into %s.", turninto);
            break;
        case 4:
            pline(msgc_fatal, "You have become %s.", turninto);
            break;
        }
    }
