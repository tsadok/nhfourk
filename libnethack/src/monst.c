...
#define LVL(lvl,mov,ac,mr,aln) lvl,mov,ac,DEFAULT_STEALTH,mr,aln
#define SLVL(lvl,mov,ac,st,mr,aln) lvl,mov,ac,st,mr,aln
 ...
 */
    ...
    MON("imp", S_IMP,
        ...
        0, CLR_ORANGE),
    MON("quasit", S_IMP,
        SLVL(3, 18, 2, 2, 20, -7), (G_GENO | G_SGROUP | 1),
 ...
 */
    MON("sewer rat", S_RODENT,
        SLVL(0, 12, 7, 2, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("giant rat", S_RODENT,
        SLVL(1, 10, 7, 2, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
    MON("cave spider", S_SPIDER,
        SLVL(1, 12, 3, 3, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
    ...
    MON("gray elder dragon", S_DRAGON,
        LVL(18, 12, -1, 60, 4), (G_GENO | G_NOGEN),
    ...
    MON("white elder dragon", S_DRAGON,
        LVL(18, 12, -1, 60, -5), (G_GENO | G_NOGEN),
        A(ATTK(AT_BREA, AD_COLD, 4, 10), ATTK(AT_BITE, AD_COLD, 4, 10),
          ATTK(AT_CLAW, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, 0, MS_ROAR, MZ_GIGANTIC), MR_COLD, MR_COLD,
    ...
    MON("black elder dragon", S_DRAGON,
        LVL(18, 12, -1, 60, -6), (G_GENO | G_NOGEN),
    ...
    MON("blue elder dragon", S_DRAGON,
        LVL(18, 12, -1, 60, -7), (G_GENO | G_NOGEN),
    ...
    MON("great gray dragon", S_DRAGON,
        LVL(22, 16, -1, 90, 4), (G_GENO | G_NOGEN),
    ...
    MON("great white dragon", S_DRAGON,
        LVL(22, 16, -1, 90, -5), (G_GENO | G_NOGEN),
        A(ATTK(AT_BREA, AD_COLD, 5, 10), ATTK(AT_BITE, AD_COLD, 5, 10),
          ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
          NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, 0, MS_ROAR, MZ_GIGANTIC), MR_COLD, MR_COLD,
    ...
    MON("great black dragon", S_DRAGON,
        LVL(22, 16, -1, 90, -6), (G_GENO | G_NOGEN),
    ...
    MON("great blue dragon", S_DRAGON,
        LVL(22, 16, -1, 90, -7), (G_GENO | G_NOGEN),
 ...
 */
    ...
    MON("air elemental", S_ELEMENTAL,
        SLVL(8, 36, 2, 2, 30, 0), (G_NOCORPSE | 1),
 ...
 */
    MON("gnome", S_GNOME,
        SLVL(1, 6, 10, 2, 4, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
    ...
    MON("ghost", S_WRAITH,
        SLVL(10, 3, -5, 2, 50, -5), (G_NOCORPSE | G_NOGEN),
    ...
    MON("shade", S_WRAITH,
        SLVL(12, 10, 10, 4, 0, 0), (G_NOCORPSE | G_NOGEN),
 ...
 */
    ...
    MON("elf", S_HUMAN,
        SLVL(10, 12, 10, 3, 2, -3), G_NOGEN,        /* for corpses */
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Woodland-elf", S_HUMAN,
        SLVL(4, 12, 10, 3, 10, -5), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        MRACE_ELF, M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
    ...
    MON("Green-elf", S_HUMAN,
        SLVL(5, 12, 10, 3, 10, -6), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        MRACE_ELF, M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
    ...
    MON("Grey-elf", S_HUMAN,
        SLVL(6, 12, 10, 3, 10, -7), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        MRACE_ELF, M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
    ...
    MON("elf-lord", S_HUMAN,
        SLVL(8, 12, 10, 4, 20, -9), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        MRACE_ELF, M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
    ...
    MON("Wizard of Yendor", S_HUMAN,
        SLVL(30, 12, -8, 2, 100, A_NONE), (G_NOGEN | G_UNIQ),
