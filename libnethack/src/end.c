...
/* Last modified by Jonadab the Unsightly One, 2017-Sep-25 */
...
static const char *const ends[] = {     /* "when you..." */
    ...
    "turned into slime", "exploded", "disintegrated", "were wiped out",
...
static const char *const killer_verb[] = {
    ...
    "exploded", "disintegrated", "wiped out",
    "committed trickery", "quit", "escaped", "ascended"
};
