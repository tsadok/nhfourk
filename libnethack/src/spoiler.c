...
{
    return msgprintf("%s%s%s%s%s%s%s%s" "%s%s",
                     /* M3 least significant byte */
                     (((mflags & M3_WANTSAMUL) && !(mflags & M3_COVETOUS)) ?
                                                          "<span class=\"flgwantsamul\">Amulet</span> " : ""),
                     (((mflags & M3_WANTSBELL) && !(mflags & M3_COVETOUS)) ?
                                                          "<span class=\"flgwantsbell\">Bell</span> " : ""),
                     (((mflags & M3_WANTSBOOK) && !(mflags & M3_COVETOUS)) ?
                                                          "<span class=\"flgwantsbook\">Book</span> " : ""),
                     (((mflags & M3_WANTSCAND) && !(mflags & M3_COVETOUS)) ?
                                                          "<span class=\"flgwantscand\">Candellabrum</span> " : ""),
                     (((mflags & M3_WANTSARTI) && !(mflags & M3_COVETOUS)) ?
                                                          "<span class=\"flgwantsarti\">Artifact</span> " : ""),
                     ((mflags & M3_COVETOUS)            ? "<span class=\"flgcovetous\">Covetous</span> " : ""),
                     /* There's an open bit here */
                     ((mflags & M3_WAITFORU)            ? "<span class=\"flgwaitforu\">WaitForU</span> " : ""),
...
*/
    ...
    if (change_fd_lock(fd, FALSE, LT_WRITE, 10)) {
        ...
        fprintf(outfile, "<table class=\"races\"><thead>\n"
                ...
                "      <th class=\"player race\">Race</th><th>mask</th>\n"
