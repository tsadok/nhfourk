...
/* Last modified by Jonadab the Unsightly One, 2017-Apr-03 */
...
setup_palette(void)
{
    ...
    static const uncursed_palette16 palette_alt3 = {{
        ...
        {0x26,0x8B,0xD2},{0xAD,0x7F,0xA8},{0x2A,0xA1,0x98},{0xEE,0xE8,0xD5},
        {0x88,0x88,0x88},{0xEF,0x29,0x29},{0x8A,0xE2,0x34},{0xFC,0xE9,0x4F},
        {0x73,0x9F,0xFF},{0xF3,0x36,0x82},{0x34,0xE2,0xE2},{0xFF,0xFF,0xFF},
        }};
    ...
    static const uncursed_palette16 palette_vga = {{
        {0x00,0x00,0x00}, {0xaa,0x00,0x00}, {0x00,0xaa,0x00}, {0xaa,0x55,0x00},
        {0x00,0x00,0xaa}, {0xaa,0x00,0xaa}, {0x00,0xaa,0xaa}, {0xaa,0xaa,0xaa},
        {0x55,0x55,0x55}, {0xff,0x55,0x55}, {0x55,0xff,0x55}, {0xff,0xff,0x55},
        {0x55,0x55,0xff}, {0xff,0x55,0xff}, {0x55,0xff,0xff}, {0xff,0xff,0xff},
        }};
    static const uncursed_palette16 palette_september = {{
        {0x00,0x00,0x00}, {0xcc,0x00,0x00}, {0x00,0xaa,0x11}, {0xaa,0x55,0x33},
        {0x00,0x55,0xcc}, {0xaa,0x00,0xcc}, {0x00,0xcc,0xbb}, {0xcc,0xcc,0xcc},
        {0x66,0x66,0x66}, {0xff,0x88,0x44}, {0x99,0xff,0x33}, {0xff,0xff,0x33},
        {0x55,0xaa,0xff}, {0xcc,0x11,0xff}, {0x11,0xff,0xdd}, {0xff,0xff,0xff},
        }};
    static const uncursed_palette16 palette_septbrite = {{
        {0x00,0x00,0x00}, {0xff,0x00,0x00}, {0x00,0xee,0x11}, {0xcc,0x77,0x55},
        {0x00,0x88,0xff}, {0xbb,0x33,0xee}, {0x00,0xff,0xcc}, {0xdd,0xdd,0xdd},
        {0x99,0x99,0x99}, {0xff,0x88,0x44}, {0xbb,0xff,0x66}, {0xff,0xff,0x33},
        {0x88,0xbb,0xff}, {0xff,0x55,0xff}, {0xaa,0xff,0xdd}, {0xff,0xff,0xff},
        }};
    ...
    case PALETTE_TERTIARY:
        ...
        return;
    case PALETTE_SEPTEMBER:
        uncursed_set_palette16(&palette_september);
        return;
    case PALETTE_SEPTBRITE:
        uncursed_set_palette16(&palette_septbrite);
        return;
    ...
    case PALETTE_REDMOND:
        ...
        return;
    case PALETTE_VGA:
        uncursed_set_palette16(&palette_vga);
        return;
