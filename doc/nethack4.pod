...
Numerous.  If you find a bug, please do report it.  Usually the
fastest way to get a response is on IRC (#nethack4 on freenode).
You can also email the developers.

Currently there is no public bug tracker.  We had one, but it had to
be taken down for technical reasons.  We would like to replace it but
