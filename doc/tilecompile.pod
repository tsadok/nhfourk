...
If you find a bug, please report it, either in the public bug tracker
at L<http://roguelikes.live/nh4-bugzilla/> or via IRC (#nethack4 on
freenode) or email (my username is jonadab and my ISP's mail server is
at columbus.rr.com).
