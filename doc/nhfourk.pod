...
Plenty.  Bugs that can also be reproduced in NetHack 4 should be
reported to that bug tracker at L<http://trac.nethack4.org>.  Bugs
that may be unique to NetHack Fourk, or have not been reproduced in
vanilla NetHack 4, should be reported directly to Jonadab instead.
