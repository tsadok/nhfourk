=for comment
Last modified by Jonadab the Unsightly One, 2015-Nov-10
...
IRC network; there is also a channel, #nhfourk, also on freenode), or
via email (my email username is jonadab, and the domain name to use is
that of my ISP, columbus.rr.com, and of course you put an at sign
between them).  I try to keep an eye on rec.games.roguelike.nethack on
Google Groups and /r/nethack on reddit as well.

Currently, there is no public bug tracker.  This is not because I
don't want to offer one but rather because I don't have a good place
to host it.
